...
import { securityCheckerAgentSystemMessage } from '../../agent-system-messages/agent-system-messages';
...
export class SecurityScannerAgent extends BaseAgent {
	...
	protected readonly systemMessage = securityCheckerAgentSystemMessage;
